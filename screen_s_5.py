...
font_c = pygame.font.SysFont("Monospace",15)
font_l = pygame.font.SysFont("Monospace",30)

def screen_s_5():
    screen_s_5 = pygame.display.set_mode((X,Y))
    running = 1
    while running:
        for event in pygame.event.get():
            if(event.type == pygame.QUIT):
                ...
                if(event.key == pygame.K_1 or event.key == pygame.K_KP1):
                    ...
                    game_screen_5()                         #Calling the game screen for 5 by 5 grid level 1
                elif(event.key == pygame.K_2 or event.key == pygame.K_KP2):
                    pygame.mixer.music.stop()
                    game_screen_l2()                  #Calling the game scren for teh 5 by 5 grid level 2
                elif(event.key == pygame.K_b):
                    return
                    pygame.display.update()
        screen_s_5.fill((0,0,0)) 
        ...
        screen_s_5.blit(head1_s,(180,10))
        screen_s_5.blit(head2_s,(200,10))
        screen_s_5.blit(head3_s,(220,10))
        screen_s_5.blit(head4_s,(240,10))
        screen_s_5.blit(head5_s,(260,10))
        screen_s_5.blit(head6_s,(270,10))
        five_l = font_l.render("Level - 1",0,(255,0,0))
        six_l = font_l.render("Level - 2",0,(0,255,0))
        screen_s_5.blit(five_l,(160,200))
        screen_s_5.blit(six_l,(160,240))
        di = font_c.render("Press the number to go to the respective level",1,(0,0,255))
        screen_s_5.blit(di,(10 ,450))
        pygame.display.flip()   
